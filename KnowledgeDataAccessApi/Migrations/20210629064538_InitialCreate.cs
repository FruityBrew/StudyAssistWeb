...
namespace KnowledgeDataAccessApi.Migrations
{
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "IssuesUnderStudy",
                columns: table => new
                {
                    IssueUnderStudyId = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssueId = table.Column<int>(type: "int", nullable: false),
                    UserId = table.Column<int>(type: "int", nullable: false),
                    RepeateDate = table.Column<DateTime>(type: "datetime2", nullable: true),
                    StudyLevel = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_IssuesUnderStudy", x => x.IssueUnderStudyId);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Issues_ThemeId",
                table: "Issues",
                column: "ThemeId");

            migrationBuilder.CreateIndex(
                name: "IX_Themes_CatalogId",
                table: "Themes",
                column: "CatalogId");
        }
